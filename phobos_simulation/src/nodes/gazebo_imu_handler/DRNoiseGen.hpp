...
#include <phobos_simulation/ImuNoiseGenConfig.h>
...
class DRNoiseGen{
    dynamic_reconfigure::Server<phobos_simulation::ImuNoiseGenConfig> server;
    dynamic_reconfigure::Server<phobos_simulation::ImuNoiseGenConfig>::CallbackType f;
protected:
    double orient_noise;
...
public:
    ...
    void Callback(phobos_simulation::ImuNoiseGenConfig &config, uint32_t level){

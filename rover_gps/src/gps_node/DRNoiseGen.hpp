...
#include <rover_gps/DRNoiseGenConfig.h>
...
class DRNoiseGen{
    dynamic_reconfigure::Server<rover_gps::DRNoiseGenConfig> server;
    dynamic_reconfigure::Server<rover_gps::DRNoiseGenConfig>::CallbackType f;
protected:
    double x_noise;
    double y_noise;
    double z_noise;
...
public:
    ...
    void Callback(rover_gps::DRNoiseGenConfig &config, uint32_t level){
